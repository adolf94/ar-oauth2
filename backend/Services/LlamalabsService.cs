...
namespace backend.Services
{
    public class LlamalabsService
    {
        ...
        public async Task SendCloudReceiveAsync(string email, string secret, string device, object payload)
        {
            ...
            var url = $"https://llamalab.com/automate/cloud/receive?to={Uri.EscapeDataString(email)}&secret={Uri.EscapeDataString(secret)}&device={Uri.EscapeDataString(device)}&payload={Uri.EscapeDataString(payloadJson)}";
